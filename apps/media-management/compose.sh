...
docker compose -f $COMPOSE_FILE --env-file $DEFAULT_ENV_FILE --env-file $NETWORKING_ENV_FILE --env-file $MS_NETWORKING_ENV_FILE --env-file $OVERRIDE_ENV_FILE $COMMAND "$@"